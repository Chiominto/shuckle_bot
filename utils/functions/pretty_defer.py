...
async def pretty_defer(
    ...
    content: str = "Please wait while Shuckle thinks...",
    embed: discord.Embed | None = None,
    ephemeral: bool = True,
):
    """
    Fully safe Shuckle loader for interactions.
...
async def pretty_error(
    ...
    """
    Standalone ephemeral error sender for Shuckle.
    - Always ephemeral.
    - Uses Shuckle's error emoji.

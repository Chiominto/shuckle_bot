...
from constants.celestial_constants import KHY_USER_ID, CELESTIAL_SERVER_ID, CELESTIAL_ROLES, CELESTIAL_TEXT_CHANNELS
from utils.functions.cleanup_first_match import cleanup_first_match
from utils.logs.debug_log import debug_log, enable_debug
from utils.logs.pretty_log import pretty_log

BONUS_NAME = f"Checklist Shiny Bonus Active!"
BONUS_EFFECT = f"+25% {Emojis.Shiny} Checklist Pokemon spawn rates."
NEW_EMOJI = "🆕"
PLUS_EMOJI = "➕"
CHECK_EMOJI = "✅"
...
class ToggleShinyBonusButton(discord.ui.View):
    ...
    async def toggle_shiny_bonus(
        ...
        shiny_bonus_role = interaction.guild.get_role(CELESTIAL_ROLES.shiny_bonus)

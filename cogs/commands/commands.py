...
STAFF_THUMBNAIL = Thumbnails.command
START_THUMBNAIL = Thumbnails.command
PUBLIC_THUMBNAIL = Thumbnails.command
PUBLIC_EMOJI = "🌠"  # shooting star, playful celestial energy
STAFF_EMOJI = "🛡️"  # shield, Shuckle’s insane defenses
TITLE_EMOJI = "🌙"  # moon, cozy night tie‑in
FOOTER_EMOJI = "🐢"  # turtle, Shuckle’s shell identity
...
class CommandsView(commands.Cog):
    ...
    @app_commands.command(name="commands", description="View Shuckle's commands!")
